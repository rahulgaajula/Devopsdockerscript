...
git clone -b master http://rahulgaajula:We!come123@github.com/rahulgaajula/launcher.git
echo "--------------------------------------------------------"
...
echo $7 | $3/rancher-compose --url $4/v1/ --access-key $5 --secret-key $6 --project-name PRR_SN --verbose rm
echo "--------------------------------------------------------"
sleep 15
# Create rancher service of <Module>
echo "Creating given DIWO service in Rancher........."
echo $7 | $3/rancher-compose --url $4/v1/ --access-key $5 --secret-key $6 --project-name PRR_SN --verbose create
echo "--------------------------------------------------------"
sleep 15

# Start rancher service of <Module>
echo "Starting created DIWO service in Rancher..........."
echo $7 | $3/rancher-compose --url $4/v1/ --access-key $5 --secret-key $6 --project-name PRR_SN --verbose start
echo "--------------------------------------------------------"
